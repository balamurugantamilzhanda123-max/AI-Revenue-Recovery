...
class Product(Base):
    ...
    image_source: Mapped[str] = mapped_column(String(40), nullable=False, default="LOCAL")
    image_status: Mapped[str] = mapped_column(String(40), nullable=False, default="IMAGE_AVAILABLE")
